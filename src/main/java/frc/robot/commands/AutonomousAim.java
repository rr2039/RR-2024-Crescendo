...
public class AutonomousAim extends Command {
  ...
  public AutonomousAim(DriveSubsystem m_drive, PoseEstimatorSubsystem m_poseEst, XboxController m_driveCont) {
    drive = m_drive;
    poseEst = m_poseEst;
  ...
  public void end(boolean interrupted) {
    drive.powDrive(0, 0, 0, true, false, false);
  }
