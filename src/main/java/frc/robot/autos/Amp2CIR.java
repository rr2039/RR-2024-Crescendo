...
public class Amp2CIR extends SequentialCommandGroup {
  /** Creates a new Amp2CIR. */
  public Amp2CIR(Shooter shooter, Shoulder shoulder, Intake intake, PoseEstimatorSubsystem poseEst, LEDUtility ledUtil, XboxController driver, XboxController oper, DriveSubsystem drive) {
